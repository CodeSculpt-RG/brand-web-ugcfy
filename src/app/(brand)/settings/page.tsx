                        ...
                        <div className="space-y-6 border-t lg:border-t-0 lg:border-l border-slate-200/80 pt-6 lg:pt-0 lg:pl-8">
                          ...
                          <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 flex items-center justify-between gap-4">
                            ...
                            <button
                              ...
                              className={`w-11 h-6 rounded-full transition-colors relative outline-none border cursor-pointer border-slate-200 shrink-0 ${enable2FA ? "bg-brand-red-600 border-brand-red-600" : "bg-slate-200"
                                }`}
                            >
                              <span
                                className={`absolute top-0.5 left-0.5 bg-white size-4.5 rounded-full shadow-sm transition-transform ${enable2FA ? "translate-x-5" : "translate-x-0"
                                  }`}
                              />
                            </button>
                          </div>
                      ...
                      <div className="bg-gradient-to-r from-brand-red-600 to-rose-700 text-white p-6 rounded-3xl shadow-md relative overflow-hidden shadow-brand-red-500/20">
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <h3 className="text-2xl font-extrabold tracking-tight mt-3">Go Plus Pro</h3>
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 50 }}
            className={`fixed bottom-6 right-6 z-50 px-5 py-3 rounded-xl shadow-xl text-xs font-bold text-white flex items-center gap-2 ${toast.type === "success" ? "bg-emerald-600 shadow-emerald-500/10" : "bg-brand-red-600 shadow-brand-red-500/10"
              }`}
          >
